...
if(!function_exists('arbi_scripts')) {
	function arbi_scripts() {
		...
		// Styles
		wp_register_style('fontawesome', 'https://fonts.googleapis.com/css?family=Roboto:300&display=swap', null, '1.0.0', 'all');
		...
		wp_register_style('style', get_stylesheet_uri(), 'fontawesome', '1.0.0', 'all');
